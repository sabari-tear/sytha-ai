...
export default function DocumentChat({ userId }: DocumentChatProps) {
  ...
  const processDocuments = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessages([{
          role: 'assistant',
          content: `Successfully processed ${uploadedFiles.length} document(s). You can now ask questions about your documents.`
        }]);
      }
    } catch (error) {
    ...
    <div className="p-6 h-full flex flex-col">
      <div className="mb-4">
        ...
        <p className="text-gray-600 text-sm mb-4">
          Upload any documents and chat about them. The system will only use the content
          from your uploaded documents to answer questions, without any legal context.
        </p>
      ...
      <form onSubmit={handleSubmit} className="flex gap-2">
        <input
          ...
          placeholder={documentsProcessed ? "Ask about your documents..." : "Please upload and process documents first"}
